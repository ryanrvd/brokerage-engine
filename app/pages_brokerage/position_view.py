...
def _overview_data(engine_key: str) -> dict[str, dict]:
    ...
    if engine_key == db.ENGINE_BROKERAGE:
        ...
        # CA required on every row, both branches.
        cohort_sql = (
    ...
    for b in ALL_BUCKETS:
        ...
        # Distinct clubs looking at this position — secondary card label.
        ...
        # Raw request count (UNION ALL, all 19 leagues) — drives the headline
        # ratio so it reconciles to the engine tension table exactly.
